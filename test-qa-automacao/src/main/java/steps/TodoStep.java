...
public class TodoStep {
    ...
    public void que_eu_esteja_na_pagina(String url) {
        ...
        //Para fins de teste criei uma classe que simula "FakeDatabase" que simula um script SQL que prepara
        //nossa massa de teste.
        FakeDatabase.inicializarMassaTeste();
    }
    ...
    public void clico_na_caixa_de_checkbox_da_tarefa() {
        page.setTarefaConcluida(FakeDatabase.ANDAR_BIKE);
    }

    @Entao("tarefa devera ser removida da tabela")
    public void tarefa_devera_ser_removida_da_tabela() {
        assertTrue(page.verificaTabelaContemTarefa(FakeDatabase.ANDAR_BIKE));
    }
